...
def train_svm(training_points, kernel_fn=dot_product, max_iter=500,
              show_graph=False, animate=True, animation_delay=0.5, manual_animation=False):
    ...
    while iteration < max_iter:
        ...
        for i in training_points:
            ...
            print('Gutters: {}'.format(list(p.name for p in svm.support_vectors if abs(dot_product(svm.w, p) + svm.b) == 1)))
            print('Support Vectors: {}'.format(list(p.name for p in svm.support_vectors)))
